...
class News_model extends Base_Model
{
    ...
    public function get_news_list($user_id, $page, $pageSize) {
    ...
    public function get_news_count($user_id) {
        $countAll = $this->db->from(TABLE_NEWS)
                            ->where('user_id', $user_id)
                            ->count_all_results();
    ...
    public function delete($user_id, $news_id) {
        $userId = $this->db->from(TABLE_NEWS)
                            ->select('user_id')
                            ->where('news_id', $news_id)
                            ->get()
                            ->row_array();
